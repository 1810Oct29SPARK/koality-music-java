...
public interface ProfileService {
	...
	boolean updatePublisherCredentials(int id, String oldUsername, String newUsername, String oldPassword, String newPassword);

	boolean updateCustomerCredentials(int id, String oldUsername, String newUsername, String oldPassword, String newPassword);
